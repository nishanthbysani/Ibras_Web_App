        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Sales',
                        data: [<?php echo $netearningsmonthly ?>, <?php echo $netearningsdaily ?>],
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)'
                        ],
            ...
            var myChart1 = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [<?php echo $monthlyorders?>, <?php echo $dailyorders?>],
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)'
                        ],
        ...
        <script>
            ...
            var myChart2 = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Profits',
                        data: [<?php echo $netearningsmonthly*0.15 ?>, <?php echo $netearningsdaily*0.15 ?>],
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)'
                        ],
